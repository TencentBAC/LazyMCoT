...
class BatchProcessor:
    ...
    def __init__(self, max_batch_size: int = 8, max_queue_size: int = 100) -> None:
        self.model = LangSAM(
            ...
            sam_ckpt_path="/path/to/ckpt/sam2.1-hiera-small/sam2.1_hiera_small.pt",
            gdino_model_ckpt_path="/path/to/ckpt/grounding-dino-base",
            gdino_processor_ckpt_path="/path/to/ckpt/grounding-dino-base",
        )
